...
var backgroundSong, explosionSound, waterSound, laughSound;
...
function preload() {
  ...
  backgroundSong = loadSound("assets/assets_background_music.mp3");
  explosionSound = loadSound("assets/assets_cannon_explosion.mp3");
  waterSound = loadSound("assets/assets_cannon_water.mp3");
  laughSound = loadSound("assets/assets_pirate_laugh.mp3");
}
